        ...
        private void InitButtonStyle(ExpandButtonStyle style)
        {
            ...
            switch (_expandButtonStyle)
            {
                case ExpandButtonStyle.MagicArrow:
                    var bmp = NinfiaDSToolkit.Properties.Resources.Upload;
                    bmp.RotateFlip(RotateFlipType.Rotate180FlipNone);
                    pictureBox1.Image = bmp;
                    break;
                case ExpandButtonStyle.Circle:
                    bmp = NinfiaDSToolkit.Properties.Resources.icon_expand;
                    pictureBox1.Image = bmp;
                    break;
                case ExpandButtonStyle.Triangle:
                    pictureBox1.Image = NinfiaDSToolkit.Properties.Resources._1downarrow1;
                    break;
                case ExpandButtonStyle.FatArrow:
                    bmp = NinfiaDSToolkit.Properties.Resources.up_256;
                    bmp.RotateFlip(RotateFlipType.Rotate180FlipNone);
                    pictureBox1.Image = bmp;
                    break;
                case ExpandButtonStyle.Classic:
                    bmp = NinfiaDSToolkit.Properties.Resources.icon_struct_hide_collapsed;
                    bmp.RotateFlip(RotateFlipType.Rotate180FlipNone);
                    pictureBox1.Image = bmp;
                    break;
                default:
