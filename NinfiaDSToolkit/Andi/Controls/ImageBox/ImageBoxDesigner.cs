...
namespace NinfiaDSToolkit.Andi.Controls.ImageBox // ReSharper restore CheckNamespace
{
  // Cyotek ImageBox
  ...
  public class ImageBoxDesigner : ControlDesigner
  {
    ...
    protected AndiImageBox ImageBoxControl
    {
      get { return this.Component as AndiImageBox; }
    }
