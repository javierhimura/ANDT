...
namespace NinfiaDSToolkit.Andi.Controls.ImageBox
{
  // Cyotek ImageBox
  ...
  [ToolboxBitmap(typeof(AndiImageBox), "ImageBox.bmp")]
  [ToolboxItem(true)]
  /* [Designer("Cyotek.Windows.Forms.Design.ImageBoxDesigner", Cyotek.Windows.Forms.ImageBox.Design.dll, PublicKeyToken=58daa28b0b2de221")] */ public class AndiImageBox : VirtualScrollableControl
  {
    ...
    public virtual int IndexParent
    {
        get; set; }
