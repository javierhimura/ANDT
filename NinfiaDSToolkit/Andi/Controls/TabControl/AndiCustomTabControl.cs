...
namespace NinfiaDSToolkit.Andi.Controls.TabControl
{
	
	[ToolboxBitmap(typeof(System.Windows.Forms.TabControl))]
	public class AndiCustomTabControl : System.Windows.Forms.TabControl
	{
		
		#region	Construction

		public AndiCustomTabControl(){
		...
		private AndiCustomTabStyleProvider _StyleProvider;
		...
		public AndiCustomTabStyleProvider DisplayStyleProvider {
			get {
				if (this._StyleProvider == null){
					this.DisplayStyle = TabStyle.Default;
				}
		...
		public TabStyle DisplayStyle {
			...
			set {
				if (this._Style != value){
					this._Style = value;
					this._StyleProvider = AndiCustomTabStyleProvider.CreateProvider(this);
					this.Invalidate();
				}
			}
		}
...
//		}
		...
		protected override void OnPaint(PaintEventArgs e){
			...
			//	this.Invalidate();
			//}
            // Bypass clipping by creating a new graphics context
            var g = CreateGraphics();

            if (!_lastClipRect.Equals(e.ClipRectangle))
            {
                ResetDoubleBuffering();
                _lastClipRect = e.ClipRectangle;
            }
