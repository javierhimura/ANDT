...
using NinfiaDSToolkit.Andi.Controls.TabControl.TabStyleProviders;

namespace NinfiaDSToolkit.Andi.Controls.TabControl
{
	[System.ComponentModel.ToolboxItem(false)]
	public abstract class AndiCustomTabStyleProvider : Component
	{
		#region Constructor
		...
		protected AndiCustomTabControl _TabControl;
		...
		protected virtual void DrawTabCloser(int index, Graphics graphics){
			if (this._ShowTabCloser){
				...
				using (GraphicsPath closerPath = AndiCustomTabStyleProvider.GetCloserPath(closerRect)){
