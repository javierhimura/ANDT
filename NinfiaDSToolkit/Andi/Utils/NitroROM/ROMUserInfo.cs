    ...
    public class ROMUserInfo
    {
        ...
        public ROMUserInfo(string ROMPath)
        {
            ...
            try
            {
                ...
                string[] lines = global::System.Text.Encoding.ASCII.GetString(file.getContents()).Split('\n');
            ...
            {
                global::System.Windows.Forms.MessageBox.Show(String.Format(LanguageManager.Get("ROMUserInfo", "ErrorRead"), lineNum + 1, ex.Message));
            }
        }
        ...
        public void SaveFile()
        {
            try
            {
                ...
                DSFileSystem.File file = ROM.FS.getFileByName("00DUMMY");
                file.beginEdit(this);
                file.replace(global::System.Text.Encoding.ASCII.GetBytes(text), this);
                file.endEdit(this);
            }
            catch (Exception ex)
            {
                global::System.Windows.Forms.MessageBox.Show(String.Format(LanguageManager.Get("ROMUserInfo", "ErrorWrite"), ex.Message));
            }
        }
    }
}
